{{ if site.Data.doks.alert -}}
  {{ partial "header/alert.html" . }}
{{ end -}}

{{ if site.Data.doks.navbarSticky -}}
...
<header class="navbar navbar-expand-lg">
  {{ with site.Data.doks.containerBreakpoint -}}
    <div class="container-{{ . }}">
  {{ else -}}
    <div class="container">
  {{ end -}}
    ...
    <div class="offcanvas offcanvas-end h-auto" tabindex="-1" id="offcanvasNavMain" aria-labelledby="offcanvasNavMainLabel">
      ...
      <div class="offcanvas-body d-flex flex-column flex-lg-row justify-content-between">
        ...
        <!-- Language dropdown -->
        {{ if eq site.Data.doks.multilingualMode true -}}
        ...
        <!-- Versioning dropdown  -->
        {{ if eq site.Data.doks.docsVersioning true -}}
        ...
        <div class="dropdown mt-1 order-lg-3">
          <button class="btn btn-dropdown dropdown-toggle" id="doks-versions" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static" aria-label="Toggle version menu">
            <span class="d-none">Doks</span> v{{ site.Data.doks.docsVersion }}
            <span class="dropdown-caret">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-down" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                <path d="M6 9l6 6l6 -6"></path>
          ...
          <ul class="dropdown-menu dropdown-menu-lg-end me-lg-2 shadow rounded border-0" aria-labelledby="doks-versions">
            <li><a class="dropdown-item current" aria-current="true" href="/docs/{{ site.Data.doks.docsVersion }}/prologue/introduction/">Latest ({{ site.Data.doks.docsVersion }}.x)</a></li>
            <li><hr class="dropdown-divider"></li>
        ...
        <!-- Color mode toggler -->
        {{ if and (eq site.Data.doks.colorMode "auto") site.Data.doks.colorModeToggler -}}
        ...
        {{ if site.Data.doks.navBarButton -}}
          <a class="btn btn-primary rounded-pill mt-2 btn-block d-lg-none" href="{{ site.Data.doks.navBarButtonUrl | absURL }}" role="button">{{ site.Data.doks.navBarButtonText }}</a>
        {{ end -}}
      </div>
    </div>
    ...
    {{ if site.Data.doks.navBarButton -}}
      <a class="btn btn-primary rounded-pill ms-3 me-2 px-4 order-lg-3 d-none d-lg-block" href="{{ site.Data.doks.navBarButtonUrl | absURL }}" role="button">{{ site.Data.doks.navBarButtonText }}</a>
    {{ end -}}
