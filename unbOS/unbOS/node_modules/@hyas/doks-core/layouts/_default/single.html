{{ define "main" }}
	<div class="row flex-xl-nowrap">
		...
		<div class="col-lg-5 col-xl-4 docs-sidebar{{ if ne site.Data.doks.navbarSticky true }} docs-sidebar-top{{ end }}{{ if site.Data.doks.headerBar }} docs-sidebar-offset{{ end }} d-none d-lg-block">
